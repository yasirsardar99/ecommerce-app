            ...
            <button
              onClick={() => {
                navigate("/cart");
                {
                  cartItemAmount > 0
                    ? navigate("/cart")
                    : addToCart(id) && navigate("/cart");
                }
              }}
              className="btn btn-sm btn-dark btn-outline-light border-dark mx-2 border rounded-pill"
            >
              {" "}
              shop now{" "}
            </button>
            <button
              className="h-6 btn px-5 btn-sm btn-light btn-outline-dark border-dark border rounded-pill"
